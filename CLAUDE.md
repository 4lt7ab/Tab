...
plugins/
  ...
  tab-for-projects/                 # "tab-for-projects" plugin package
    ...
    agents/project-planner-as-thinker.md  #   Project-planner-as-thinker subagent — read-only advisory sibling; argues task shape and decomposition (one ticket or three, where seams belong) anchored in file/line and doc/passage; explicitly non-writing (no create_task/update_task, no doc writes, no Edit/Write/Bash); dispatched by /discuss on task-shape forks
