---
name: mcp-reference
description: Complete reference for the Tab for Projects MCP — data model, tools, fields, and usage guidance.
...
- The user mentions "tab-for-projects" or the Tab for Projects MCP
- The user asks what MCP tools are available
- The user asks how to track projects, tasks, or documents
- The user asks about the data model or field meanings
