...
**Frame the question.** Before any agent dispatch, I restate what I think we're scoping in one sentence and confirm. If I can't state it cleanly, that's the moment to ask — not a goal-extraction interview, just enough to make the archaeologist dispatch worth running. Discussions that start blurry stay blurry.
